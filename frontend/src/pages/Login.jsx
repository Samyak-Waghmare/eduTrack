            ...
            <div className="hidden lg:flex flex-1 relative overflow-hidden items-center justify-center p-12">
                ...
                <div className="relative z-10 text-white max-w-md w-full">
                    ...
                    <div className="flex items-center gap-3 mb-12">
                        ...
                        <div>
                            <h1 className="text-2xl font-black tracking-tight">EduTrack</h1>
                    ...
                    <p className="text-white/65 text-lg leading-relaxed mb-10">
                        Join thousands of learners mastering new skills and advancing their careers with EduTrack.
                    </p>
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-background">
                <div className="w-full max-w-[420px] space-y-7">
                    ...
                    <div className="lg:hidden text-center">
                        ...
                        <h1 className="text-2xl font-black gradient-text">EduTrack</h1>
                    </div>
